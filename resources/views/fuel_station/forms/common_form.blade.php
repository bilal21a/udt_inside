...
<div class="mb-4">
    ...
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="fuel_type" id="inlineRadio1" value="is_petrol"
             {{ $fuel_type == 'is_petrol' ? 'checked' : '' }}>

        <label class="form-check-label" for="inlineRadio1">Petrol</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="fuel_type" id="inlineRadio2" value="is_diesel"
             {{ $fuel_type == 'is_diesel' ? 'checked' : '' }} >
        <label class="form-check-label" for="inlineRadio2">Diesel</label>
    </div>
    <div class="form-check form-check-inline">
        <input class="form-check-input" type="checkbox" name="fuel_type" id="inlineRadio2" value="is_hi_oct"
            {{ $fuel_type == 'is_hi_oct' ? 'checked' : '' }}>
...
<div class="mb-3">
    ...
    @if (isset($fuelpump) && $fuelpump->approval_certificate_image != null)
        <div class="sh-15 me-1 mb-1 d-inline-block">
            <img src="{{ $fuelpump->approval_certificate_image_url }}" class="img-fluid-height rounded-md" alt="thumb">
...
<div class="mb-3">
    ...
    @if (isset($fuelpump) && $fuelpump->fuel_station_image != null)
        <div class="sh-15 me-1 mb-1 d-inline-block">
            <img src="{{ $fuelpump->fuel_station_image_url }}"
