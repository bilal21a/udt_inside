...
@section('content')
    ...
    <div class="container">
        ...
        <div class="page-title-container">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h1 class="mb-0 pb-0 display-4" id="title"> Toll Gates Management</h1>
                </div>
            </div>
        </div>

        <a class="btn btn-icon btn-icon-start btn-primary mb-4"
            href="{{ route('toll_gate.create', ['service_provider' => $service_provider]) }}">
        ...
        @php
            $tableName = 'datatable';
            $tableData = ['Toll Gate Image', 'Location Title', 'Address', 'Status', 'Actions'];
        @endphp
