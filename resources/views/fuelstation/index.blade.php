        ...
        <div class="page-title-container">
            <div class="row">
                <div class="col-12 col-sm-6">
                    <h1 class="mb-0 pb-0 display-4" id="title">Fuel Station Managment</h1>
                </div>
            </div>
        </div>

        <a class="btn btn-icon btn-icon-start btn-primary mb-4" href="{{ route('fuelstation.create') }}">
            <i data-acorn-icon="plus"></i>
            <span>Add Fuel Stations</span>
        </a>
