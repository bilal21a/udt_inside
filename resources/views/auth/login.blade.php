        ...
        <div class="row justify-content-center align-items-center authentication authentication-basic h-100">
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-6 col-sm-8 col-12">
                <div class="my-5 d-flex justify-content-center">
                    <a href="index.html">
                        <img src="{{ asset('assets/logo/logo_full_dark.png') }}" alt="logo" class="desktop-logo" style="height:65px" >
                        <img src="{{ asset('assets/logo/logo_full_light.png') }}" alt="logo" class="desktop-dark" style="height:65px" >
                    </a>
                </div>
                <div class="card custom-card">
                    <div class="card-body p-5">
                        ...
                        <div class="text-center">
                            {{-- <p class="fs-12 text-muted mt-3">Dont have an account? <a href="#"
